...
class AI85SimpleNetBatchNorm(nn.Module):
    """
    SimpleNet v1 Model
    """
    def __init__(
        ...
        super(AI85SimpleNetBatchNorm, self).__init__()

        self.conv1 = ai8x.FusedConv2dBNReLU(num_channels, 16, 3, stride=1, padding=1, bias=bias)
        self.conv2 = ai8x.FusedConv2dBNReLU(16, 20, 3, stride=1, padding=1, bias=bias)
        self.conv3 = ai8x.FusedConv2dBNReLU(20, 20, 3, stride=1, padding=1, bias=bias)
        self.conv4 = ai8x.FusedConv2dBNReLU(20, 20, 3, stride=1, padding=1, bias=bias)
        self.conv5 = ai8x.FusedMaxPoolConv2dBNReLU(20, 20, 3, pool_size=2, pool_stride=2,
                                                   stride=1, padding=1, bias=bias)
        self.conv6 = ai8x.FusedConv2dBNReLU(20, 20, 3, stride=1, padding=1, bias=bias)
        self.conv7 = ai8x.FusedConv2dBNReLU(20, 44, 3, stride=1, padding=1, bias=bias)
        self.conv8 = ai8x.FusedMaxPoolConv2dBNReLU(44, 48, 3, pool_size=2, pool_stride=2,
                                                   stride=1, padding=1, bias=bias)
        self.conv9 = ai8x.FusedConv2dBNReLU(48, 48, 3, stride=1, padding=1, bias=bias)
        ...
        self.conv11 = ai8x.FusedMaxPoolConv2dBNReLU(96, 512, 1, pool_size=2, pool_stride=2,
                                                    padding=0, bias=bias)
        self.conv12 = ai8x.FusedConv2dBNReLU(512, 128, 1, stride=1, padding=0, bias=bias)
...
def ai85simplenetbatchnorm(pretrained=False, **kwargs):
    """
    Constructs a SimpleNet v1 model.
    """
    assert not pretrained
    return AI85SimpleNetBatchNorm(**kwargs)


models = [
    {
        'name': 'ai85simplenetbatchnorm',
        'min_input': 1,
        'dim': 2,
    },
]
