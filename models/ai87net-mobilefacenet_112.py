...
[1] Chen, Sheng, et al. "Mobilefacenets: Efficient cnns for accurate real-time face verification on mobile devices.
" Biometric Recognition: 13th Chinese Conference, CCBR 2018, Urumqi, China, August 11-12, 2018, Proceedings 13. Springer International Publishing, 2018.
"""
import torch
...
class AI87MobileFaceNet(nn.Module):
    ...
    def __init__(  # pylint: disable=too-many-arguments
        ...
        self.classifier = ai8x.FusedAvgPoolConv2d(last_layer_width, emb_dimensionality, 1, padding=0,
...
def ai87netmobilefacenet_112(pretrained=False, **kwargs):
    ...
    return AI87MobileFaceNet(pre_layer_stride=1, bottleneck_settings=bottleneck_settings,
                           last_layer_width=128, emb_dimensionality=64, avg_pool_size=(7,7),  depthwise_bias=True, reduced_depthwise_bias = True, **kwargs)
models = [
    {
