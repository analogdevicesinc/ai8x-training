...
def KWS_get_datasets(data, load_train=True, load_test=True):
    """
...
datasets = [
    {
        'name': 'KWS_few',  # 20 keywords
        'input': (128, 128, 1),
        'output': kws_config.output,
        'weights': kws_config.weights,
