...
__all__ = ['SResNet', 'sresnet8', 'SSResNet', 'sresnet6', 'SSSResNet', 'sresnet4',
           'LResNet', 'lresnet18']
...
def sresnet8(pretrained=False, **kwargs):
    """Constructs a ResNet-8 model.

    """
    assert not pretrained
    return SResNet(BasicBlock, [1, 1, 1], **kwargs)
...
def sresnet6(pretrained=False, **kwargs):
    """Constructs a ResNet-6 model.

    """
    assert not pretrained
    return SSResNet(BasicBlock, [1, 1], **kwargs)
...
def sresnet4(pretrained=False, **kwargs):
...
def lresnet18(pretrained=False, **kwargs):
    """Constructs a ResNet-18 model with dropout.
    """
    assert not pretrained
    return LResNet(BasicBlock, [2, 2, 2, 2], **kwargs)
