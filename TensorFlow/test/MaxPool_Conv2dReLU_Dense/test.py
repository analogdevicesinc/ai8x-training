...
model = tf.keras.Model(inputs=[input_layer], outputs=[conv1, maxpool1, flat, output_layer])
...
print('Pool output(8-bit):\n', clamp(np.floor(maxpool1_out*128+0.5)))
