#!/bin/sh
./cnn-gen.py --verbose --autogen tests --top-level cnn -L --test-dir tests --prefix fmnist --checkpoint-file ai84.pth.tar --c-library --config-file fashionmnist-chw.yaml --stop-after 0 --verify-writes
